...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{route('admin.departamentos.store') }}" method="post" class="form-horizontal">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="nombre" placeholder="Imgrese su nombre" value="{{ old('nombre')}}" autofocus minlength="3" maxlength="55"
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    @if ($errors->has('direccion'))
                                        <span class="error text-danger" for="input-direccion" style="font-size: 15px">{{ $errors->first('direccion') }}</span>
                                    @endif
                                </div>
                            </div>
                        </div>
