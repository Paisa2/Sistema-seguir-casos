@extends('layouts.dashboard.index', ['activePage' => 'municipios', 'titlePage' => 'Nuevo municipio'])
@section('main-content')
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <form action="{{ route('admin.municipios.store') }}" method="post" class="form-horizontal">
                    @csrf
                    <div class="card">
